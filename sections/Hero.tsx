...
import RomiaFlow from "@/components/hero/RomiaFlow";
...
export default function Hero({ locale, dict }: HeroProps) {
  return (
    <main className="relative flex min-h-screen items-center pt-24">
      {/* Grid background */}
      <div
      ...
      <div className="container-romia relative z-10">
        <div className="grid items-center gap-8 lg:grid-cols-[1.4fr_0.6fr]">
          ...
          <div className="pl-18 pr-8">
            ...
            {/* Title */}
            <motion.h1
              className="mb-6 text-[clamp(4rem,10vw,8rem)] font-black leading-none tracking-tight"
          ...
          <div className="hidden lg:flex justify-start items-start pt-8">
            <RomiaFlow steps={dict.hero.heroFlow} />
          </div>
